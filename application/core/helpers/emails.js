...
const send_email = async (template_path, to_email, subject, email_data = {}, from_email = null) => {
        ejs.renderFile(get_template('auth/user.email.verify.ejs'), email_data, (err, html) => {
        if (html){
